...
const checks = [
  ...
  ["Vercel AI SDK package", "npm", ["pack", "--dry-run"], "ai-sdk-aipg"],
  ["Vercel AI SDK packed consumer", "npm", ["run", "test:package:ai-sdk"], "."],
  ...
  ["ElizaOS package", "npm", ["pack", "--dry-run"], "elizaos-aipg"],
  ["ElizaOS packed consumer", "npm", ["run", "test:package:elizaos"], "."],
