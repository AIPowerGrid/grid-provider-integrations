...
Image-to-video accepts one inline start frame. Remote URL inputs, frame arrays,
and reference collections are rejected because the current Grid request
contract does not support them.
